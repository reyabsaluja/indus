...
import { createMarketStream, unavailableMarketStream } from './lib/market-stream'
...
const context = {
  ...
  queryClient,
  api,
  marketStream: import.meta.env.VITE_MARKET_STREAM_URL
    ? createMarketStream(import.meta.env.VITE_MARKET_STREAM_URL, () => auth.accessToken())
    : unavailableMarketStream,
}
